...
class LegalAI:
    ...
    def process_legal_case(self, case_text):
        # Ensure case_text is not empty or just whitespace
    ...
    def answer_question(self, user_query):
        # Ensure user_query is not empty or just whitespace
        ...
        st.write(f"Messages being sent: {messages}")
...
if api_key:
    ...
    if user_query:
        ...
        if response:
            ...
            st.write("No valid response from the model.")
else:
